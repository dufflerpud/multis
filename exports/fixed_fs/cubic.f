Cindx#	cubic.for - Play against the computer, first to get 4 in a line
C@HDR@	$Id$
C@HDR@
...
C------------------------------------------------------------------------
Cdoc#	cubic.for - Play against the computer, first to get 4 in a line
Cdoc#	Originally made with Robert Kenney's Macro-10 USRPAK.MAC.
C------------------------------------------------------------------------
C	*** CUBIC.FOR ***
	subroutine fmain
