Cindx#	life.for - Yet another simulator for John Conways game of life
C@HDR@	$Id$
C@HDR@
...
C------------------------------------------------------------------------
Cdoc#	life.for - Yet another simulator for John Conway's game of life
Cdoc#	Made with Bob Kenney's USRPAK.MAC.
Cdoc#	Lots of things are configurable beyond Conway's original game.
C------------------------------------------------------------------------
C	*** LIFE.FOR ***
	subroutine fmain
